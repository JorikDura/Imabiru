...
Route::group(['prefix' => 'v1'], function () {
    ...
    Route::group(['prefix' => 'users'], function () {
        ...
        Route::group(['prefix' => '{user}/comments'], function () {
            ...
            Route::get('/{id}', ShowUserCommentController::class);
        });
    });
    ...
    Route::group(['prefix' => 'posts'], function () {
        ...
        Route::group(['prefix' => '{post}/comments'], function () {
            ...
            Route::get('/{id}', ShowPostCommentController::class);
        });
    });
    ...
    Route::group([
        ...
        Route::group(['prefix' => 'users'], function () {
            ...
            Route::group(['prefix' => '{user}/comments'], function () {
                ...
                Route::delete('{commentId}', DeleteUserCommentController::class)
        ...
        Route::group(['prefix' => 'posts'], function () {
            ...
            Route::group(['prefix' => '{post}/comments'], function () {
                ...
                Route::delete('/{commentId}', DeletePostCommentController::class)
                    ->middleware(['throttle:6,3']);
            });
        });
    });
